import { TasksStateType, tasksThunks, tasksReducer } from 'features/tasks-management/model/tasks.slice';
...
test('empty arrays should be added when we set todolists-management', () => {
...
test('tasks-management should be added for todolist', () => {
